...
CREATE TABLE IF NOT EXISTS orders(
  ...
  KEY idx_fk_delivery_person_id (delivery_person_id),
  CONSTRAINT fk_orders_delivery_person FOREIGN KEY (delivery_person_id) REFERENCES delivery_person (delivery_person_id) ON DELETE RESTRICT ON UPDATE CASCADE,
  ...
  CONSTRAINT fk_orders_resturant FOREIGN KEY (resturant_id) REFERENCES resturants (resturant_id) ON DELETE RESTRICT ON UPDATE CASCADE
);
